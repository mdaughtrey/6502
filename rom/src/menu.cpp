...
{'b', "Set Breakpoint", Validator("([0-9a-fA-F]{4})", "XXXX"), pio_break::cmd_set },
{'B', "Clear Breakpoint", Validator("([0-9a-fA-F]{4})", "XXXX"), pio_break::cmd_clear },
...
{'D', "Debug Init", Validator(""), pio_break::cmd_debug_mode_init },
...
{'l', "List Breakpoints", Validator(""), pio_break::cmd_list },
...
{'O', "Toggle Pin Max Hz (NN)", Validator("([0-9]{2})", "Pin Number (NN)"), cmd_io::cmd_toggle_pin_max },
...
{
    'd', "Dump Memory, bus disabled (XXXX/XXXX)",
...
{'w', "Write to Memory, bus disabled (XXXX/XX) ", Validator("([0-9a-fA-F]{4})/([0-9a-fA-F]{2})", "Enter addr/value (XXXX/XX)"), rom_ram::cmd_write_memory},
{'x', "Main Menu", Validator(""), [](CommandInput)->bool { command_set = commands_top; return false; }},
{0x01, "", Validator(""), [](CommandInput input)->bool { return false;} }
};
...
Command commands_via6522[] = {
    ...
    {'?', "help", Validator(""), cmd_help },
    {'r', "Set Register", Validator("([0-9a-fA-F]{2})/([0-9a-fA-F]{2})", "Register/Value (XX/XX)"), via6522::cmd_set_register },
    {'x', "Main Menu", Validator(""), [](CommandInput)->bool { command_set = commands_top; return false; }},
    {0x01, "", Validator(""), [](CommandInput input)->bool { return false;} }
};
